...
import com.localink.android.core.network.ProtocolHttpClient
import com.localink.android.core.network.local.LocalHttpHostService
import com.localink.android.core.network.local.LocalHttpRequest
import com.localink.android.core.network.local.LocalHttpResponse
...
import com.localink.android.core.protocol.ProtocolConstants
import com.localink.android.core.protocol.ProtocolEnvelope
import com.localink.android.core.protocol.ProtocolEnvelopeFactory
import com.localink.android.core.protocol.ProtocolEnvelopeValidator
import com.localink.android.core.protocol.ProtocolError
import com.localink.android.core.protocol.ProtocolErrorCodes
import com.localink.android.core.protocol.ProtocolJson
import com.localink.android.core.protocol.ProtocolMetadata
import com.localink.android.core.protocol.ProtocolPacketTypes
import com.localink.android.core.protocol.decodeEnvelope
import com.localink.android.core.storage.StorageDirectories
import com.localink.android.models.ConnectionLifecycleState
import com.localink.android.models.DevicePeer
import com.localink.android.models.LocalDeviceProfile
import com.localink.android.models.TransferDirection
import com.localink.android.models.TransferItem
import com.localink.android.models.TransferState
...
class LanFileTransferService(
    ...
    override fun queueFiles(uris: List<Uri>) {
        scope.launch {
            ...
            uris.distinct().forEach { uri ->
                ...
                val maxFileSize = if (session.peer.transportMode == com.localink.android.models.AppConnectionMode.BluetoothFallback) {
                ...
                if (selectedFile.size > maxFileSize) {
                    loggerService.warning(
                        "Skipped ${selectedFile.fileName} because it exceeds the ${if (session.peer.transportMode == com.localink.android.models.AppConnectionMode.BluetoothFallback) "300 MB Bluetooth" else "20 GB hotspot/LAN"} limit."
                    )
                    return@forEach
                }

                val chunkSize = if (session.peer.transportMode == com.localink.android.models.AppConnectionMode.BluetoothFallback) {
    ...
    private suspend fun sendPrepare(
        ...
        if (session.peer.transportMode == com.localink.android.models.AppConnectionMode.BluetoothFallback) {
    ...
    private suspend fun sendChunk(
        ...
        val boundary = "LocalinkBoundary${UUID.randomUUID().toString().replace("-", "")}"
