...
@Immutable
class LocalinkStrings private constructor(
    ...
    fun receiveFolderHeadline(settings: LocalinkSettings): String {
    ...
    companion object {
        fun forLanguage(language: AppLanguage): LocalinkStrings {
            return LocalinkStrings(
                language = language,
...
val LocalAppStrings = staticCompositionLocalOf { LocalinkStrings.forLanguage(AppLanguage.English) }

@Composable
fun rememberLocalinkStrings(language: AppLanguage): LocalinkStrings {
    return remember(language) {
        LocalinkStrings.forLanguage(language)
    }
}
