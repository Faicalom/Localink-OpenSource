...
class PreferencesSettingsRepository(
    ...
    override val settings: Flow<LocalinkSettings> = context.dataStore.data.map { preferences ->
    ...
    private fun Preferences.toSettings(): LocalinkSettings {
        val folderName = normalizeReceiveFolderName(this[receiveFolderLabelKey])
        return LocalinkSettings(
