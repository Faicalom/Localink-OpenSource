...
class LocalBridgeStrings private constructor(
    ...
    companion object {
        ...
        private val englishValues = mapOf(
            ...
            "pairing_field_supporting" to "Use the Windows code in this field. The Android code shown above is only for Windows when the desktop initiates.",
            "scan_pairing_qr" to "Scan QR",
            "scan_qr_title" to "Scan Windows QR",
            "scan_qr_supporting" to "Point the camera at the QR code shown in the Windows app to start a direct local connection.",
            "scan_qr_preview_hint" to "Hold steady until the code is detected automatically.",
            "scan_qr_cancel" to "Cancel",
            "scan_qr_invalid" to "That QR code does not contain a valid Windows pairing payload.",
            "scan_qr_permission_denied" to "Camera permission is required to scan the Windows QR code.",
            "scan_qr_camera_error" to "Could not start the QR scanner on this device.",
            "scan_qr_direct_connect_only" to "No matching Windows peer is ready yet. Refresh peers, then scan the QR again.",
            ...
            "refresh_peers" to "Refresh peers",
        ...
        private val arabicValues = mapOf(
            ...
            "pairing_field_supporting" to "استخدم رمز ويندوز في هذا الحقل. الرمز الظاهر أعلاه هو رمز أندرويد الخاص بك ويُعطى لويندوز فقط عندما يبدأ الكمبيوتر الجلسة.",
            "scan_pairing_qr" to "قراءة QR",
            "scan_qr_title" to "قراءة QR الخاص بويندوز",
            "scan_qr_supporting" to "وجّه الكاميرا نحو رمز QR الظاهر في تطبيق ويندوز لبدء اتصال محلي مباشر.",
            "scan_qr_preview_hint" to "ثبّت الهاتف قليلًا حتى يتم اكتشاف الرمز تلقائيًا.",
            "scan_qr_cancel" to "إلغاء",
            "scan_qr_invalid" to "رمز QR هذا لا يحتوي على بيانات اقتران ويندوز صالحة.",
            "scan_qr_permission_denied" to "يلزم إذن الكاميرا لقراءة رمز QR الخاص بويندوز.",
            "scan_qr_camera_error" to "تعذّر تشغيل قارئ QR على هذا الجهاز.",
            "scan_qr_direct_connect_only" to "لا يوجد جهاز ويندوز مطابق جاهز الآن. حدّث الأجهزة ثم أعد قراءة QR.",
            ...
            "refresh_peers" to "تحديث الأجهزة",
